...
extension ImageResource {
    ...
    static let grumman = ImageResource(name: "Grumman", bundle: resourceBundle)

    /// The "toronto" asset catalog image resource.
    static let toronto = ImageResource(name: "toronto", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "Grumman" asset catalog image.
    static var grumman: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .grumman)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "Grumman" asset catalog image.
    static var grumman: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .grumman)
#else
        .init()
